 ...
 *
 * Nothing here is a clinical instrument. It summarises the records Predyqt holds, and
...
const SCORE_DISCLAIMER =
    'Your score summarises the records in Predyqt — it is not a diagnosis. Always discuss results with a clinician.';
 ...
 * in Predyqt look like, which is the only thing this number actually knows.
 */
const BANDS = [
    {
        key: 'healthy',
        ...
        max: 100,
        description:
            'Most of what Predyqt tracks for you is sitting where it should. Keep logging — '
...
/**
 * BMI, from the most recent weight Predyqt holds.
 *
...
/**
 * Score one person from everything Predyqt holds about them.
 *
